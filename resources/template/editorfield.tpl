<!-- if $formReadOnly -->
	...
	<!-- assign globalDisabled=" disabled=\"disabled\"" -->
<!-- else -->
...
<div id="{$id}_main" style="background-color:#f0f0ee;border:1px solid #ccc;">
  ...
  <div id="{$id}_container" style="margin-top:1px;">
    <div id="{$id}_window">
      ...
      <textarea id="{$id}_textarea" style="width:{$width}px;height:{$height}px;display:none" rows="" cols=""></textarea>
    </div>
  ...
  <div id="{$id}_divemoticons" class="editorDivEmoticons">
    <table width="100%" cellpadding="1" cellspacing="1" style="border:none;background-color:#000000">
      ...
      <tr><td align="center" style="padding:2px;background-color:Window">
        <!-- loop name="emoticonLoop" var=$emoticons item="emoticon" --><img class="editorEmoticon" src="{$iconPath}emoticons/{$emoticon}.gif" alt="" border="0" /><!-- if ($p2g.loop.emoticonLoop.rownum mod 7) eq 0 --><br /><!-- else --><!-- end if --><!-- end loop -->
      </td></tr>
    </table>
  </div>
