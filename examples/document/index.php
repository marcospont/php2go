 ...
 */
	 ...
	 */
	$doc = new Document('../common/headermenumain.tpl');
	...
	// add a CSS file
	$doc->addStyle('../common/examples.css', 'screen');
	// associate this document to an RSS feed
	$doc->addAlternateLink('application/rss+xml', '../feedcreator/index.php', "Feed Creator example");
	 ...
	 */
	$header->includeAssign('include_block', 'include.tpl', T_BYFILE);
	/**
	 ...
	 */
	$menu =& $doc->createElement('menu', 'menu.tpl');
