<?php
	...
	// $Header: /www/cvsroot/php2go/examples/authdb.example.php,v 1.16 2006/11/02 19:17:14 mpont Exp $
	// $Revision: 1.16 $
	...
	class MyHTMLPage extends Document
	{
		...
		function MyHTMLPage($layout) {
			 ...
			 */
			parent::addStyle('resources/css.example.css');
		}
	}

	$page = new MyHTMLPage('resources/basicLayout.example.tpl');
	$main =& $page->createElement('main', 'resources/authdb.example.tpl');
