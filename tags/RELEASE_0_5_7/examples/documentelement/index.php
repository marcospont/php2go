 ...
 */
	 ...
	 */
	$document = new Document('../common/headermenumain.tpl');
	 ...
	 */
	$document->assign('menu', file_get_contents('menu.html'));
	 ...
	 */
	$element->put('include1.tpl', T_BYFILE);
	$element->put('include2.tpl', T_BYFILE);
