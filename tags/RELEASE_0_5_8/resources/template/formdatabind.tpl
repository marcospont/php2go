...
<script type="text/javascript" for="{$csvDbName}" event="ondatasetcomplete">
	setTimeout(function() {
...
<table width="100%" cellpadding="6" cellspacing="0" border="0">
  <tr>
    <td align="left" width="48%" nowrap="nowrap">
...
<table width="100%" cellpadding="6" cellspacing="0" border="0">
  <tr>
    ...
    <td align="right"><div id="{$formName}_recCount"{$labelStyle}></div></td>
  </tr>
</table>
