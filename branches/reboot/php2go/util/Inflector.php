...
final class Inflector
{
	...
	public static function humanize($word, $ucfirst=false) {
		$uppercase = ($ucfirst ? 'ucfirst' : 'ucwords');
		return $uppercase(str_replace('_', ' ', self::underscore($word)));
	}
	...
	public static function unaccent($str) {
        ...
        if (Util::isUTF8($str)) {
			...
			$str = strtr($string, $in, $out);
			// double chars
			$in = array(chr(140), chr(156), chr(198), chr(208), chr(222), chr(223), chr(230), chr(240), chr(254));
