...
{if(!window.GBrowserIsCompatible||!GBrowserIsCompatible())return this;var opts=$.extend({},$.fn.gMap.defaults,options);return this.each(function()
{$gmap=new GMap2(this);$(this).data('gMap',$gmap);$geocoder=new GClientGeocoder();if(opts.address)
...
$gmap.setMapType(opts.maptype);if(opts.controls.length==0)
{$gmap.setUIToDefault();}
else
